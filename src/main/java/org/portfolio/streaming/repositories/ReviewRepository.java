...
public interface ReviewRepository extends JpaRepository <Review, Long> {
    ...
    @Query(nativeQuery = true, value = "SELECT user_sys.id AS userId, user_sys.email AS username, review.review, review.rating FROM tb_review AS review INNER JOIN "
        ...
        public List<UserReviewProjection> searchReviewsByMovieId(@Param("movieId") Long movieId);
    ...
    public Optional<UserReviewProjection> searchReviewAndUserByReviewId(Long id);
